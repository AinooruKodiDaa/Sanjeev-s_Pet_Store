...
export const ViewPetModal: React.FC<any> = (props) => {
  const { isModalOpen, setIsModalOpen } = useIsModalOpen();

  const images = [
    { id: 1, src: "/images/dog1.jpg" },
    { id: 2, src: "/images/dog2.jpg" },
    { id: 3, src: "/images/dog3.jpg" },
  ];
  ...
  return (
    <Modal open={isModalOpen.isViewPetModalOpen} onClose={setClose}>
      <Fade in={isModalOpen.isViewPetModalOpen}>
        <Box
          sx={{
            position: "absolute",
            top: "50%",
